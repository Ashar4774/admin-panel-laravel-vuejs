                ...
                <div class="modal-body">
                    <form method="POST" id="invoiceForm" @submit.prevent="AddInvoiceForm">
                        ...
                        <div class="row">
                            ...
                            <div class="col-md-6">
                                <div class="form-group">
                                    <input type="date" class="form-control form-control-sm" id="due_date" v-model="prop.formState.due_date" placeholder="Due Date">
...
const AddInvoiceForm = async () => {
    await axios.post('/api/invoices', {
        ...
        addInvoiceModelClose();
            ...
            prop.formState.amount.value= '',
            prop.formState.due_date.value= '',
            prop.formState.rcd_amount.value= '',
            prop.formState.rcd_due_date.value= '',
            prop.formState.status.value= '',
            prop.formState.payment_type.value= '',
            prop.formState.bad_debt_amount.value= '',
            prop.formState.notes.value= '-'
    }).catch(error=>{
