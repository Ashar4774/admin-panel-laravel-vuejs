        ...
        <div class="container-fluid py-1 px-3">
            <nav aria-label="breadcrumb">
                <ol class="breadcrumb bg-transparent mb-0 pb-0 pt-1 px-0 me-sm-6 me-5">
                    <li class="breadcrumb-item text-sm"><router-link :to=" `/${breadcrum}` " class="opacity-5 text-dark">{{ breadcrum }}</router-link></li>
                    <li class="breadcrumb-item text-sm text-dark active text-capitalize" aria-current="page"></li>
                </ol>
...
<script setup>
    ...
    const breadcrum = computed(()=> state.state.breadcrum)
